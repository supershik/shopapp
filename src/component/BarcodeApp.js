...
export default class BarcodeApp extends Component {
  ...
  _onPressBack () {
    let item = {qrvalue: "none", from: 'barcode_back'};
    this.props.navigation.navigate('Shop Billing', item);
  }
  onOpenlink() {
  ...
  onBarcodeScan(qrvalue) {
    ...
    let item = {qrvalue: qrvalue, from: 'barcode'};
    this.props.navigation.navigate('Shop Billing', item);
  }
  onOpneScanner() {
    var that =this;
    ...
    if (!this.state.opneScanner) {
      return (
        <View style={styles.container}>
            <Text style={styles.heading}>Please start barcode scanner</Text>
